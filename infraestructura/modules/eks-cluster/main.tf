...
# Módulo VPC: Crea una red con subredes públicas y privadas
module "vpc" {
...
# Módulo EKS: Crea el clúster y los nodos
module "eks" {
...
# Rol IAM para el AWS Load Balancer Controller
...
resource "aws_iam_role_policy_attachment" "aws_load_balancer_controller" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/ElasticLoadBalancingFullAccess" # Simplificado para Free Tier
}
